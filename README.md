Escola de Línguas - Modelagem de Dados

Descrição
Modelo de banco de dados para uma escola de línguas que gerencia professores, alunos, cursos, turmas, aulas e presença.
...
Links
- Diagrama online (draw.io): https://app.diagrams.net/#G1PD0IQx-COQ1CFAscsJcijXBpSebXK9qx#%7B%22pageId%22%3A%2283xq7hKN179RFUJIKOLB%22%7D  
- Arquivo (.drawio / export): https://drive.google.com/file/d/1PD0IQx-COQ1CFAscsJcijXBpSebXK9qx/view?usp=sharing

O que tem neste repositório
- Diagrama DER# Escola-de-L-nguas---Modelagem-de-Dados
- script SQL: 
